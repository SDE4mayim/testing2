describe('open',() =>{
    it('verify',() =>{
        ...
        cy.get("#username").type("DV_Srivathsan_1")
        ...
        cy.get('.btn').click()
        cy.get('.MuiAlert-message').should("contain","Error creating Hospital Profile : Profile creation error")
        //fail
