...
cy.get('[href="/psd"] > .MuiListItemText-root > .MuiTypography-root').click()
    ...
    cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(1)').type('1265')
    ...
    cy.get('.MuiGrid-container > :nth-child(4)').type('mncbdknvb')
    cy.get('.MuiGrid-container > :nth-child(5)').type('kjckdjbck')
    cy.get('.MuiGrid-container > :nth-child(6)').click()
    cy.get('[data-value="400004"]').click()
    cy.get('.MuiGrid-container > :nth-child(7)').type('878949')
    cy.get('.MuiGrid-container > :nth-child(8)').click()
    cy.get('[data-value="raw"]').click()
    cy.get('.MuiGrid-container > :nth-child(9)').type('mnbmvnv')
