...
cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(1)').type('34512678905')
cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(2)').type('@0987')
cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(3)').type('!@#$')
cy.get('.MuiGrid-container > :nth-child(4)').type('0987')
...
cy.get('.MuiGrid-container > :nth-child(8)').type('0987@mail.com')
...
cy.get('.MuiGrid-container > :nth-child(14)').type('dfghjhgf')
