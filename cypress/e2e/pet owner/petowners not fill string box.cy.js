describe('user',()=>{
    ...
    cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(1)').type('leesungkum ')
    cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(2)').type('Lnh')
    cy.get('.MuiDialogContent-root > .MuiGrid-container > :nth-child(3)').type('do something')
    cy.get('.MuiGrid-container > :nth-child(4)').type('kumar')
    cy.get('.MuiGrid-container > :nth-child(5)').click()
    cy.get('[data-value="male"]').click()
    cy.get('.MuiGrid-container > :nth-child(6)').type('0987654321')
    cy.get('.MuiGrid-container > :nth-child(7)').type('1234509876')
    cy.get('.MuiGrid-container > :nth-child(8)').type('1234@')
    cy.get('.MuiGrid-container > :nth-child(9)').type("2020-02-13")
    cy.get('.MuiGrid-container > :nth-child(10)').type('nobitta')
